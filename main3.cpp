...
QGraphicsTextItem *q1 = new QGraphicsTextItem();
...
void MyTimer::MyTimerSlot()
{
   //qDebug() << "Timer...";
    ...
    file2->setFileName("sensor.txt");
    file2->open(QIODevice::ReadWrite);
    QString strFile2(file2->readAll());
   // QString strFile2 = "Modified Text";
    QFont f("Helvetica");
    //QRect qr = QRect(-100,0,50,120);
    //paint.drawText(qr,Qt::AlignCenter,"new text");
    //scene.addText(strFile2,f);
    q1->setPlainText(strFile2);
}
